...
const PLATFORM_META = {
  ...
  hermes: { repoId: 'gm-hermes', label: 'Hermes Agent', type: 'cli', badgeLabel: 'hermes', installSteps: [{ desc: 'Apply hermes-patch to enable hook support \u2014 copy patched files over your Hermes installation. See https://github.com/AnEntrypoint/hermes-patch' }, { desc: 'Install via npm', cmd: 'npm install -g gm-hermes' }, { desc: 'Restart Hermes Agent \u2014 skills activate automatically' }] }
};
