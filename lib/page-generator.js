...
const PLATFORM_META = {
  ...
  thebird: { repoId: 'gm-thebird', label: 'thebird (browser via Freddie + plugkit.wasm)', type: 'browser', badgeLabel: 'thebird', installSteps: [{ desc: 'install via npm', cmd: 'npm install -g gm-thebird' }, { desc: 'run installer', cmd: 'gm-thebird' }, { desc: 'restart Freddie' }] }
};
